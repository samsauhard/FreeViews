...
def search_and_click(ua,sleep_time,top5,proxy,proxies,sleep_after):
    ...
    driver = webdriver.Chrome(r'C:\Users\Sachin\Downloads\YouTube-View-Bot-master\YouTube-View-Bot-master\5\chromedriver5.exe',options=options1)
    ...
    try:  
        driver.get('https://dai.ly/x7yixdd')
        #time.sleep(3)
