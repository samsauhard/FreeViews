...
def search_and_click(ua,sleep_time,top5,proxy,proxies,sleep_after):
    ...
    driver = webdriver.Chrome(r'C:\Users\Sachin\Downloads\YouTube-View-Bot-master\YouTube-View-Bot-master\2\chromedriver2.exe',options=options1)
    #options.add_experimental_option( "prefs",{'profile.managed_default_content_settings.javascript': 2})

    try:
        #driver = webdriver.Chrome(chrome_options=options)
    #query = search_string_to_query(search_string)
        driver.get('https://dai.ly/x7ygfor')
